            ...
            <div>
              ...
              {user && (
                <p className="text-blue-600 mt-1">
                  Hello, {user.first_name === 'business' ? 'Business' : user.first_name === 'influencer' ? 'Creator' : user.first_name || user.username}!
                </p>
              )}
            </div>
            {activeTab === 'dashboard' && (
              <div className="flex space-x-3">
                <button 
                  ...
                  disabled={aiLoading}
                  className="bg-green-600 text-white px-4 py-3 rounded-xl font-medium hover:bg-green-700 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center space-x-2 disabled:opacity-50"
                >
                  <Bot className="w-5 h-5" />
                  <span>{aiLoading ? 'Testing...' : 'Test AI'}</span>
                </button>
                <button 
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                  ...
                  {aiError ? (
                    <div className="p-4 bg-red-50 border border-red-200 rounded-xl">
                      <p className="text-red-700 font-medium">Error: {aiError}</p>
                    </div>
                  ) : (
                    <div className="p-4 bg-green-50 border border-green-200 rounded-xl">
                      <p className="text-green-700 font-medium mb-2">Success! Protected endpoint response:</p>
                      <pre className="text-sm text-gray-800 bg-gray-100 p-3 rounded-lg overflow-x-auto">
                        {aiResponse}
                      </pre>
                    </div>
                  )}
