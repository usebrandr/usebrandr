...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-[#1c1c1c] text-[#f5f5f5]">
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 lg:px-8 py-4 bg-[#1c1c1c]/90 backdrop-blur-sm border-b border-gray-700">
        <div className="flex items-center space-x-4">
          <BrandrLogo size="md" variant="white" />
                      ...
                      <a href="#contact" className="text-[#f5f5f5] hover:text-white transition-colors font-medium text-lg">Contact</a>
                    </div>
      </nav>
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-gradient-to-br from-[#1c1c1c] to-[#1c1c1c] py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#f5f5f5] mb-6">Get in Touch</h2>
